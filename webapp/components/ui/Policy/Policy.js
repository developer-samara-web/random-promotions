export default function Policy() {
    return (
        <div className="policy max-w-4xl mx-auto rounded-lg">
            <h1 className="text-xl font-bold mb-4 text-gray-200">Политика в отношении обработки персональных данных</h1>

            <section className="mb-6">
                <h2 className="text-base font-semibold mb-3 text-gray-200">1. Общие положения</h2>
                <p className="text-gray-200 leading-relaxed text-sm">
                    Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. № 152-ФЗ «О персональных данных» (далее — Закон о персональных данных) и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые ИП Семерной Игорь Николаевич (далее — Оператор).
                </p>
                <p className="text-gray-200 leading-relaxed mt-2 text-sm">
                    1.1. Оператор ставит своей важнейшей целью и условием осуществления своей деятельности соблюдение прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.
                </p>
                <p className="text-gray-200 leading-relaxed mt-2 text-sm">
                    1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта <a href="https://t.me/mr_razdachkin_bot" className="text-blue-600 hover:underline">https://t.me/mr_razdachkin_bot</a>.
                </p>
            </section>

            <section className="mb-6">
                <h2 className="text-base font-semibold mb-3 text-gray-200">2. Основные понятия, используемые в Политике</h2>
                <ul className="list-disc pl-5 space-y-2 text-gray-200 text-sm">
                    ...
                    <li>2.3. Веб-сайт — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу <a href="https://t.me/mr_razdachkin_bot" className="text-blue-600 hover:underline">https://t.me/mr_razdachkin_bot</a>.</li>
                    ...
                    <li>2.8. Персональные данные — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта <a href="https://t.me/mr_razdachkin_bot" className="text-blue-600 hover:underline">https://t.me/mr_razdachkin_bot</a>.</li>
                    ...
                    <li>2.10. Пользователь — любой посетитель веб-сайта <a href="https://t.me/mr_razdachkin_bot" className="text-blue-600 hover:underline">https://t.me/mr_razdachkin_bot</a>.</li>
            ...
            <section className="mb-6">
                <h2 className="text-base font-semibold mb-3 text-gray-200">3. Основные права и обязанности Оператора</h2>
                <h3 className="text-base font-medium mb-2 text-gray-200">3.1. Оператор имеет право:</h3>
                <ul className="list-disc pl-5 space-y-2 text-gray-200 text-sm">
                ...
                <h3 className="text-base font-medium mb-2 mt-4 text-gray-200">3.2. Оператор обязан:</h3>
                <ul className="list-disc pl-5 space-y-2 text-gray-200 text-sm">
            ...
            <section className="mb-6">
                <h2 className="text-base font-semibold mb-3 text-gray-200">4. Основные права и обязанности субъектов персональных данных</h2>
                <h3 className="text-base font-medium mb-2 text-gray-200">4.1. Субъекты персональных данных имеют право:</h3>
                <ul className="list-disc pl-5 space-y-2 text-gray-200 text-sm">
                ...
                <h3 className="text-base font-medium mb-2 mt-4 text-gray-200">4.2. Субъекты персональных данных обязаны:</h3>
                <ul className="list-disc pl-5 space-y-2 text-gray-200 text-sm">
                    <li>предоставлять Оператору достоверные данные о себе;</li>
                    <li>сообщать Оператору об уточнении (обновлении, изменении) своих персональных данных.</li>
                </ul>
                <p className="text-gray-200 leading-relaxed mt-2 text-base font-medium">
                    4.3. Лица, передавшие Оператору недостоверные сведения о себе, либо сведения о другом субъекте персональных данных без согласия последнего, несут ответственность в соответствии с законодательством РФ.
                </p>
            </section>
            <section className="mb-6">
                <h2 className="text-base font-semibold mb-3 text-gray-200">5. Принципы обработки персональных данных</h2>
                <ul className="list-disc pl-5 space-y-2 text-gray-200 text-sm">
            ...
            <section className="mb-6">
                <h2 className="text-base font-semibold mb-3 text-gray-200">6. Цели обработки персональных данных</h2>
                <p className="text-gray-200 leading-relaxed text-sm"><strong>Цель обработки:</strong> информирование Пользователя посредством отправки электронных писем</p>
                <p className="text-gray-200 leading-relaxed mt-2 text-sm"><strong>Персональные данные:</strong></p>
                <ul className="list-disc pl-5 space-y-2 text-gray-200 text-sm">
                    <li>фамилия, имя, отчество</li>
                    <li>электронный адрес</li>
                    <li>номера телефонов</li>
                </ul>
                <p className="text-gray-200 leading-relaxed mt-2 text-sm"><strong>Правовые основания:</strong> уставные (учредительные) документы Оператора</p>
                <p className="text-gray-200 leading-relaxed mt-2 text-sm"><strong>Виды обработки персональных данных:</strong></p>
                <ul className="list-disc pl-5 space-y-2 text-gray-200 text-sm">
            ...
            <section className="mb-6">
                <h2 className="text-base font-semibold mb-3 text-gray-200">7. Условия обработки персональных данных</h2>
                <ul className="list-disc pl-5 space-y-2 text-gray-200 text-sm">
                    ...
                    <li>7.2. Обработка персональных данных необходима для достижения целей, предусмотрен

                        ных международным договором Российской Федерации или законом, для осуществления возложенных законодательством Российской Федерации на оператора функций, полномочий и обязанностей.</li>
            ...
            <section className="mb-6">
                <h2 className="text-base font-semibold mb-3 text-gray-200">8. Порядок сбора, хранения, передачи и других видов обработки персональных данных</h2>
                <p className="text-gray-200 leading-relaxed text-sm">
                ...
                <ul className="list-disc pl-5 space-y-2 text-gray-200 mt-2 text-sm">
                    ...
                    <li>8.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора <a href="mailto:semernoy.in@yandex.ru" className="text-blue-600 hover:underline">semernoy.in@yandex.ru</a> с пометкой «Актуализация персональных данных».</li>
                    <li>8.4. Срок обработки персональных данных определяется достижением целей, для которых были собраны персональные данные, если иной срок не предусмотрен договором или действующим законодательством. Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора <a href="mailto:semernoy.in@yandex.ru" className="text-blue-600 hover:underline">semernoy.in@yandex.ru</a> с пометкой «Отзыв согласия на обработку персональных данных».</li>
            ...
            <section className="mb-6">
                <h2 className="text-base font-semibold mb-3 text-gray-200">9. Перечень действий, производимых Оператором с полученными персональными данными</h2>
                <ul className="list-disc pl-5 space-y-2 text-gray-200 text-sm">
            ...
            <section className="mb-6">
                <h2 className="text-base font-semibold mb-3 text-gray-200">10. Трансграничная передача персональных данных</h2>
                <ul className="list-disc pl-5 space-y-2 text-gray-200 text-sm">
            ...
            <section className="mb-6">
                <h2 className="text-base font-semibold mb-3 text-gray-200">11. Конфиденциальность персональных данных</h2>
                <p className="text-gray-200 leading-relaxed text-sm">
            ...
            <section className="mb-6">
                <h2 className="text-base font-semibold mb-3 text-gray-200">12. Заключительные положения</h2>
                <ul className="list-disc pl-5 space-y-2 text-gray-200 text-sm">
                    <li>12.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к

                        Оператору с помощью электронной почты <a href="mailto:semernoy.in@yandex.ru" className="text-blue-600 hover:underline">semernoy.in@yandex.ru</a>.</li>
                    ...
                    <li>12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <a href="https://t.me/mr_razdachkin_bot" className="text-blue-600 hover:underline">https://t.me/mr_razdachkin_bot</a>.</li>
                </ul>
            </section>
        </div>
    );
