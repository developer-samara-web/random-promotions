...
export function subscribeShowRulesMessage(tariff) {
	return (`<b>🔹 Условия оказания услуг</b>\n\n<blockquote>Осуществляя оплату, <b>Вы подтверждаете ознакомление со всеми текущими тарифами сервиса</b>, а также даете согласие на дальнейшую пролонгацию платежей.\n\n${tariff.rules}</blockquote>`);
}
